...
def parser() -> argparse.ArgumentParser:
    ...
    demo = commands.add_parser("demo", help="Run the local gear-shaft example with TP coordination")
    demo.add_argument("--parameters", type=Path, help="JSON dimensions for the gear shaft")
